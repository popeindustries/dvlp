...
describe('resolver', () => {
  ...
  describe('resolve()', () => {
    ...
    it('should resolve an absolute path', () => {
      expect(resolve(path.resolve('foo.js'), path.resolve('foo.js'))).to.equal(
        path.resolve('foo.js'),
      );
    });
    ...
    it('should not resolve a sub-module of a js package module path from a deeply nested location', () => {
      expect(resolve('bar/bat', path.resolve('nested/nested/bar.js'))).to.equal(
        undefined,
      );
    });
    ...
    it('should resolve a scoped js package module source path', () => {
      ...
      ).to.equal(path.resolve('node_modules/@popeindustries/test/lib/bar.js'));
    });
