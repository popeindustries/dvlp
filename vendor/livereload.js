(function() {
  ...
  __protocol.ProtocolError = ProtocolError = (function() {
    function ProtocolError(reason, data) {
      this.message =
        'LiveReload protocol error (' + reason + ') after receiving data: "' + data + '".';
    }
      ...
      Reloader.prototype.generateCacheBustUrl = function(url, expando) {
        ...
        if (this.options.overrideURL) {
          if (url.indexOf(this.options.serverURL) < 0) {
            url =
              this.options.serverURL + this.options.overrideURL + '?url=' + encodeURIComponent(url);
          }
        }
    ...
    LiveReload.prototype.analyze = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        pluginsData[plugin.constructor.identifier] = pluginData =
          (typeof plugin.analyze === 'function' ? plugin.analyze() : void 0) || {};
    ...
    LessPlugin.prototype.reloadLess = function(path) {
      ...
      links = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          link = _ref[_i];
          if (
            (link.href && link.rel === 'stylesheet/less') ||
            (link.rel.match(/stylesheet/) && link.type.match(/^text\/(x-)?less$/))
          ) {
            _results.push(link);
          }
        }
