 ...
 * @property { string } dir
 * @property { boolean } isNpmPackage
 * @property { string } main
 * @property { string } name
 * @property { Array<string> } npmPaths
...
module.exports = {
  /**
   * Find PackageDetails for 'filePath' and cache result in 'cache'
   *
   * @param { Map<string, PackageDetails> } cache
   * @param { string } filePath
   * @returns { PackageDetails }
   */
  findPackage(cache, filePath) {
