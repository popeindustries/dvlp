...
const debug = require('debug')('dvlp:rootserver');
const fs = require('fs');
 ...
 * @param { Reloader } [options.reloader]
 ...
 * @returns { RootServer }
 */
module.exports = async function rootServerFactory(
  mainPath,
  { mockPath, port, reloader, rollupConfig, transpiler, watchDeps } = {}
) {
...
class RootServer {
   ...
   */
  constructor(main, reloader, rollupConfig, transpiler, mockPath, watchDeps) {
    this.appModules = [];
