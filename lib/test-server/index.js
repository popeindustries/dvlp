...
class TestServer {
   ...
   *
   * @param { string | ClientRequest } request
   ...
   *
   * @param { string | ClientRequest } stream
   * @param { string | Buffer } message
   * @param { object } [options]
   * @param { string } [options.delay] - delay in ms
   * @param { string } [options.event] - EventSource event name
   * @param { string } [options.id] - EventSource event id
   * @returns { void }
   */
