...
const { interceptFileRead, interceptProcessOn } = require('./utils/intercept');
...
module.exports = async function appServer(
  ...
  const instance = new AppServer(main, directories, reloader, rollupConfig, transpiler, mockpath);
